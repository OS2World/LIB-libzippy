...
public:
  ...
  void PrepareWriteCompressedDataZip64(UInt16 fileNameLength, bool isZip64, UInt32 extraSize);
  void PrepareWriteCompressedData(UInt16 fileNameLength, UInt64 unPackSize, UInt32 extraSize);
  void PrepareWriteCompressedData2(UInt16 fileNameLength, UInt64 unPackSize, UInt64 packSize, UInt32 extraSize);
