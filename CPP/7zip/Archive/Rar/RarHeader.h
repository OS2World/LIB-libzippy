...
namespace NBlockType
{
  ...
  #define kSubHeadTypeCmt    "CMT"
  #define kSubHeadTypeACL    "ACL"
  #define kSubHeadTypeStream "STM"
  #define kSubHeadTypeUOwner "UOW"
  #define kSubHeadTypeAV     "AV"
  #define kSubHeadTypeRR     "RR"
  #define kSubHeadTypeOS2EA  "EA2"
  #define kSubHeadTypeBEOSEA "EABE"
}
